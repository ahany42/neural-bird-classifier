...
def test_accuracy(X_test, y_test, weights, biases, bias):
   pass

def train_accuracy(X_train, y_train, bias, neurons_per_hidden_layer, hidden_layers, eta, epochs, mse_threshold):
    pass
